...
(function(){try{self._PN_IDC_={"id":8546,"name":"allrecipes.com","domain_key":"1s505zJTcPgEUiiSrtvjQaixszhrrYRtqwpR","time_zone":"US/Central","integration_type":"direct","custom_allow_domain":"allrecipes-updates.com","frequency_caps":null,"global_prompt_settings":{},"flags":["FEAT_NATIVE_ANDROID_NOTIFICATIONS_FG_DISPLAY","FEAT_NATIVE_IOS_NOTIFICATIONS_FG_DISPLAY","FEAT_SDK_WEB_DISABLE_SESSION_TRACKING","REPLACE_EXISTING_WORKERS","SW_NO_DOMAIN_KEY_PARAM","USE_ROOT_SW_SCOPE"],"custom_sdk_package_name":null,"vapid_public_key":"BBBFPf4Fh38LJmILdvHcigU-indW3UYlYvALf6r_LM3oBOQnh9Pccx6y_weRDOEbhmS0PtwoelU_dnwHQppmt4c","additional_subscription_data":null,"whitelist_domains":["www.allrecipes.com"],"sdk_event_only_domains":[],"apns_configuration":{"is_active":false},"ecomm_config":{"item_type":"recipe","ecomm_campaign_cooldown_period":{"interval_seconds":86400}},"domain_integrations":null}}catch(_){}})();
...
(function(){
try {
  window.PushlySDK.watchOnce("ready", () => {
    ...
    if (hid) {
      window.PushlySDK.push(["external_id", hid]);
    }
  });
} catch (e) {
}
